...
- When the user asks to compare the current product with similar products (e.g. "how does this compare?", "what's similar?", "show me alternatives"), call find_similar_products first to discover candidates, then pass the top candidate URLs into compare_products. Do NOT call benchmark_against_category alone for this use case — it returns rubric context, not a user-facing comparison table.
"""
